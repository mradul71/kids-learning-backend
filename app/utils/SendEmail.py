...
def send_email(to_emails: str, subject: str, content: str) -> tuple[bool,int]:
    message: Mail = Mail(
    	from_email='support@lambdascs.com',
	    to_emails=to_emails,
	    subject=subject,
...
def send_signup_email(to_email: str, password: str) -> None:
    ...
    subject: str = "Optiflow Account Created"
    content: str = f"""<p>Your Optiflow account creation was successful. Thanks!</p><br>
    ...
    <p>Please go to the login page for sign-in onto the platform. url: <a href= "https://optiflowsolutions.com/auth/sign-in">https://optiflowsolutions.com/auth/sign-in</a></p><br>
    <p>Thanks,<br>
    <strong>Lambda SCS Support</strong></p><p>In case of questions, please reach out to support@lambdascs.com</p>"""
    send_email(to_email, subject, content)

def send_db_setup_completion_email(to_email: str) -> None:
    subject: str = "Optiflow Organization Setup Completed"
    content: str = f"""<p>Your Optiflow acount organization setup is complete.</p><br>
...
def send_db_setup_fail_email(to_email: str) -> None:
    subject: str = "Optiflow Organization Setup Failed"
    content: str = f"""<p>Your Optiflow acount organization setup failed due to some error.</p><br>
...
def send_db_modification_completion_email(to_email: str) -> None:
    subject: str = "Optiflow Organization Database Modification Completed"
    content: str = f"""<p>Your Optiflow acount organization databse modification is complete.</p><br>
    <p>Please check admin section for created resources and to configure them.</p><br>
    <p>Please go to the login page for sign-in onto the platform. url: <a href= "https://optiflowsolutions.com/auth/sign-in">https://optiflowsolutions.com/auth/sign-in</a></p><br>
    <p>Thanks,<br>
    <strong>Lambda SCS Support</strong></p><p>In case of questions, please reach out to support@lambdascs.com</p>"""
...
def send_db_modification_fail_email(to_email: str) -> None:
    subject: str = "Optiflow Organization Database Modification Failed"
    content: str = f"""<p>Your Optiflow acount organization databse modification failed due to some error.</p><br>
...
def send_invitation_email(to_email: str, org_name: str, by_user_name: str, by_user_email: str, invitation_link: str) -> None:
    subject: str = f"{org_name} Organization Invitation | Optiflow"
...
def send_invitation_acceptance_email(to_email: str, org_name: str, accepted_user: str) -> None:
    subject: str = f"{org_name} Organization Invitation Acceptance | Optiflow"
    content: str = f"""<p>'{accepted_user}' has accepted your invitation to Organization: {org_name}.</p><br>
    <p>If not invited by you please check user-management section of the mentioned organization on the platform. url: <a href= "https://optiflowsolutions.com/admin/user-management">https://optiflowsolutions.com/admin/user-management </a></p><br>
    <p>Thanks,<br>
    <strong>Lambda SCS Support</strong></p><p>In case of questions, please reach out to support@lambdascs.com</p>"""
    send_email(to_email, subject, content)

def send_invitation_rejection_email(to_email: str, org_name: str, rejected_user: str) -> None:
    subject: str = f"{org_name} Organization Invitation Rejection | Optiflow"
...
def send_verification_email(to_email: str) -> None:
    verification_link: str = DevelopmentConfig.AUTH.generate_email_verification_link(to_email)
    subject: str = "Optiflow Email Verification"
...
def send_password_reset_email(to_email: str) -> None:
    pass_reset_link: str = DevelopmentConfig.AUTH.generate_password_reset_link(to_email)
    subject: str = "Optiflow Password Change"
